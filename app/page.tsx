...
const TESTIMONIALS = [
  {
    ...
    content: 'School Management sangat membantu kami dalam mengelola administrasi sekolah. Interface yang mudah dan fitur yang lengkap!',
    rating: 5
  },
  {
...
const HeroSection = memo(function HeroSection() {
  return (
    <section className="relative pt-24 sm:pt-32 lg:pt-40 pb-16 sm:pb-20 lg:pb-32 overflow-hidden">
      <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
        ...
        <div className="absolute bottom-20 right-10 w-32 h-32 sm:w-72 sm:h-72 bg-accent/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '700ms' }} />
...
const FeaturesSection = memo(function FeaturesSection() {
  return (
    <section id="features" className="py-16 sm:py-20 lg:py-32 relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
...
const TestimonialsSection = memo(function TestimonialsSection() {
  return (
    <section id="testimonials" className="py-16 sm:py-20 lg:py-32 relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
...
const CTASection = memo(function CTASection() {
  return (
    <section className="py-16 sm:py-20 lg:py-32 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-r from-primary/5 to-accent/5" aria-hidden="true" />
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-4 sm:mb-6">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-muted-foreground mb-8 sm:mb-12">
            Bergabunglah dengan ribuan sekolah yang sudah menggunakan School Management
          </p>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-muted-foreground text-center sm:text-right">
            © {currentYear} School Management. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
