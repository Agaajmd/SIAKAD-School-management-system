...
const Toaster = ({ ...props }: ToasterProps) => {
  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast: 'group toast group-[.toaster]:bg-background group-[.toaster]:text-foreground group-[.toaster]:border-border group-[.toaster]:shadow-lg group-[.toaster]:rounded-xl group-[.toaster]:transition-all group-[.toaster]:duration-500 group-[.toaster]:ease-out',
          ...
          closeButton: 'group-[.toast]:bg-background group-[.toast]:border-border group-[.toast]:text-muted-foreground group-[.toast]:hover:bg-muted group-[.toast]:transition-all group-[.toast]:duration-200',
        ...
        style: {
          '--toast-transition': 'all 0.4s cubic-bezier(0.16, 1, 0.3, 1)',
